...
public class ProductTest {
    ...
    @Test
    public void should_quality_increase_when_multiple_days_passed_given_an_on_date_over_10_days_become_less_than_10_days_Backstage_pass_product() {
        int sellIn = 15;
        int quality = 20;
        Product product = Product.create("Backstage pass", sellIn, quality);
        product.passDays(10);
    ...
    @Test
    public void should_quality_increase_when_multiple_days_passed_given_an_on_date_over_10_days_become_less_than_5_days_Backstage_pass_product() {
        int sellIn = 15;
        int quality = 20;
        Product product = Product.create("Backstage pass", sellIn, quality);
        product.passDays(12);
        assertEquals(41, product.getQuality());
    }

    @Test
    public void should_quality_is_0_when_multiple_days_passed_given_an_on_date_over_10_days_become_out_of_date_Backstage_pass_product() {
        int sellIn = 15;
        int quality = 20;
        Product product = Product.create("Backstage pass", sellIn, quality);
        product.passDays(20);
